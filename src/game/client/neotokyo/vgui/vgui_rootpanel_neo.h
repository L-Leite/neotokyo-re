...
#ifndef VGUI_ROOTPANEL_NEO_H
#define VGUI_ROOTPANEL_NEO_H
#ifdef _WIN32
#pragma once
#endif
...
//-----------------------------------------------------------------------------
class C_NEORootPanel : public vgui::Panel
{
	typedef vgui::Panel BaseClass;
public:
						C_NEORootPanel( vgui::VPANEL parent );
	virtual				~C_NEORootPanel( void );
