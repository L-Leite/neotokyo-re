...
void FinishClientPutInServer( CNEOPlayer *pPlayer )
{
...
void ClientPutInServer( edict_t *pEdict, const char *playername )
{
	...
	CNEOPlayer *pPlayer = CNEOPlayer::CreatePlayer( "player", pEdict );
...
void ClientActive( edict_t *pEdict, bool bLoadGame )
{
	...
	CNEOPlayer *pPlayer = ToNEOPlayer( CBaseEntity::Instance( pEdict ) );
...
{
	CreateGameRulesObject( "CNEOGameRules" );
}
