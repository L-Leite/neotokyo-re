...
#ifdef NEO_DLL
	SendPropArray3( SENDINFO_ARRAY3( m_iClassType ), SendPropInt( SENDINFO_ARRAY( m_iClassType ), 4 ) ),
	SendPropArray3( SENDINFO_ARRAY3( m_iStar ), SendPropInt( SENDINFO_ARRAY( m_iStar ), 4 ) ),
	SendPropArray3( SENDINFO_ARRAY3( m_iRank ), SendPropInt( SENDINFO_ARRAY( m_iRank ), 4 ) ),
#endif
END_SEND_TABLE()
...
#ifdef NEO_DLL
			m_iClassType.Set( i, pPlayer->m_iClassType );
			m_iStar.Set( i, pPlayer->m_iStar );
			m_iRank.Set( i, pPlayer->m_iRank );
#endif
