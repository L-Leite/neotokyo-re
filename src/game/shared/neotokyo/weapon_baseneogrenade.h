...
#ifndef WEAPON_BASENEOGRENADE_H
#define WEAPON_BASENEOGRENADE_H
#ifdef _WIN32
#pragma once
#endif
...
#include "weapon_neobase.h"
	...
	#define CBaseNEOGrenade C_BaseNEOGrenade

#endif


class CBaseNEOGrenade : public CWeaponNEOBase
{
public:
	DECLARE_CLASS( CBaseNEOGrenade, CWeaponNEOBase );
...
private:
	CBaseNEOGrenade( const CBaseNEOGrenade & ) {}
};


inline bool CBaseNEOGrenade::IsPinPulled() const
{
	return m_bPinPulled;
}


#endif // WEAPON_BASENEOGRENADE_H
