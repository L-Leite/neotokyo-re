...
#include "neotokyo_nightvision_nv_ps20.inc"
#include "neotokyo_nightvision_nv_vs20.inc"

BEGIN_VS_SHADER( neo_nightvision_nv, "Help for neotokyo_nightvision_nv" )
	...
	SHADER_DRAW
	{
		...
		{								 
			...
			DECLARE_STATIC_PIXEL_SHADER( neotokyo_nightvision_nv_ps20 );
			SET_STATIC_PIXEL_SHADER( neotokyo_nightvision_nv_ps20 );
		}
		...
		DYNAMIC_STATE
		{
			...
			BindTexture( SHADER_SAMPLER3, SLTEXTURE );
			...
			fNvTextureVal[ 1 ] = params[ SLTEXTURE ]->GetFloatValue();
