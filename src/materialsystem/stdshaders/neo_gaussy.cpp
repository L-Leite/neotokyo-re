...
#include "neotokyo_gaussy_ps20.inc"
#include "neotokyo_gauss_vs20.inc"

BEGIN_SHADER( neo_gaussy, "Help for neo_gaussy" )
	...
	SHADER_DRAW
	{
		...
		{								 
			...
			DECLARE_STATIC_PIXEL_SHADER( neotokyo_gaussy_ps20 );
			SET_STATIC_PIXEL_SHADER( neotokyo_gaussy_ps20 );
		}
