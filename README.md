# NeoTokyo
:warning: nerd game to not touch :warning:

## Credits
- Raid-8
- [softashell](https://github.com/softashell/)
- [Me](https://github.com/Ochii/)

## Building
You can follow the [Source SDK docs instructions](https://developer.valvesoftware.com/wiki/Source_SDK_2013#Setting_up_.28Platform_Specific.29) to build this.

Don't forget to grab the original game files
